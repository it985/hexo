...
date: 
updated: 
top_img: https://www.bing.com/th?id=OHR.SlothDay_EN-US8418438094_UHD.jpg
cover: https://www.bing.com/th?id=OHR.GeorgiaCypress_EN-US2966839861_UHD.jpg
keywords: 
---
# 三、Swagger快速开始
...
如果使用的是其他语言的话,想使用swagger-bootstrap-ui,建议使用她的前端分离版本`swagger-bootstrap-ui-front`,具体可参考前端分离的文档说明