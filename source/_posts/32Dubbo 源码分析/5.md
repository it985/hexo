---
title: Dubbo 源码分析 – 集群容错之Directory
keywords: Dubbo 源码分析 – 集群容错之Directory
abbrlink: 1c48ee72
categories:
tags:
date:
updated:
top_img: https://www.bing.com/th?id=OHR.ValvestinoDam_EN-GB9564618627_UHD.jpg
cover: https://www.bing.com/th?id=OHR.CrestedButteEclispe_EN-GB1381305687_UHD.jpg
---
...
toInvokers 方法一开始会对服务提供者 url 进行检测，若服务消费端的配置不支持服务端的协议，或服务端 url 协议头为 empty 时，toInvokers 均会忽略服务提供方 url。必要的检测做完后，紧接着是合并 url，然后访问缓存，尝试获取与 url 对应的 invoker。如果缓存命中，直接将 Invoker 存入 newUrlInvokerMap 中即可。如果未命中，则需要新建 Invoker。Invoker 是通过 Protocol 的 refer 方法创建的，这个我在[上一篇](http://tech.souyunku.com/?p=587)文章中已经分析过了，这里就不赘述了。
