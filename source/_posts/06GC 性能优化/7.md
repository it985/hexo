---
title: 七、GC 性能优化 – GC 调优(工具篇)
tags:
  - JVM
  - 优化
  - 工具
abbrlink: c219fcd0
date: 2020-05-30 10:10:48
categories:
top_img: https://cn.bing.com/th?id=OHR.YorkMinster_EN-US5465804030_UHD.jpg
cover: https://cn.bing.com/th?id=OHR.KindredSpirits_EN-US5529252474_UHD.jpg
keywords:  
---
# 七、GC 性能优化 – GC 调优(工具篇)
...
![img_1.png](https://s3.uuu.ovh/imgs/2022/05/09/832f55607ea44f75.png)

下图是Java Mission Control 中的截图:

![img_2.png](https://s3.uuu.ovh/imgs/2022/05/09/924f2aeead01bae3.png)
...
![img_3.png](https://s3.uuu.ovh/imgs/2022/05/09/46a0f10cd18188b3.png)
...
![img_4.png](https://s3.uuu.ovh/imgs/2022/05/09/621edbc8ec2c54ca.png)
...
![img_5.png](https://s3.uuu.ovh/imgs/2022/05/09/9ebabb926acedab5.png)
...
![img_6.png](https://s3.uuu.ovh/imgs/2022/05/09/ddf8b1965d5d6f62.png)
...
![img_7.png](https://s3.uuu.ovh/imgs/2022/05/09/e2320f87f2ee1a63.png)

完成上面的步骤后, 可以得到类似这样的信息:

![img_8.png](https://s3.uuu.ovh/imgs/2022/05/10/88ca4e4b4e866931.png)

上图按照每个类被创建的对象数量多少来排序。看第一行可以知道, 创建的最多的对象是 `int[]` 数组. 鼠标右键单击这行, 就可以看到这些对象都在哪些地方创建的:

![img_9.png](https://s3.uuu.ovh/imgs/2022/05/10/0c86f0ab8da203e7.png)
